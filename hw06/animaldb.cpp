...
//  Date: April 1st
//
//  Purpose: print all of the animals from a given animals array list or 
//           print only the animals with certain classification
//
//  Known bugs: N/A
//
//  Testing performed: It works as expected.
//
//*********************************************************************
                               ...
                               Animal_Array_List *all_animals) 
{
        ...
        for (int i = 0; i < all_animals -> num_animals(); i++) {
                if (all_animals -> animal_at(i).classification() 
                    == classification) {
                        a.add(all_animals -> animal_at(i));
                }
        }
        if (a.num_animals() == 0) {
                cerr << "No animals with classification: " << classification
                     << endl;
        } else {
                a.print();
        }
